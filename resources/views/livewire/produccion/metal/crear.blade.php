<div class=" p-2 bg-white border border-gray-200 rounded-lg shadow sm:p-4 md:p-6 dark:bg-gray-800 dark:border-gray-700">
    <form wire:submit.prevent="submit" novalidate>
        @csrf
        <h5 class="text-xl font-medium text-gray-900 dark:text-white">Dtectora de metales</h5>
        ...
        <div class="flex items-center p-2">
            <div class="flex items-center gap-2">
                <input id="ferroso" type="checkbox" wire:model="ferroso"
                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                <label for="ferroso" class="text-sm font-medium text-gray-900 dark:text-white">ferroso </label>
            </div>
        </div>

        <div class="flex items-center p-2">
            <div class="flex items-center gap-2">
                <input id="no_ferroso" type="checkbox" wire:model="no_ferroso"
                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                <label for="no_ferroso" class="text-sm font-medium text-gray-900 dark:text-white">no_ferroso </label>
            </div>
        </div>

        <div class="flex items-center p-2">
            <div class="flex items-center gap-2">
                <input id="sus_inox" type="checkbox" wire:model="sus_inox"
                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                <label for="sus_inox" class="text-sm font-medium text-gray-900 dark:text-white">sus_inox</label>
            </div>
        </div>
