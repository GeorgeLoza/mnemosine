<div>
    <div class="flex w-full gap-2 max-h-[calc(100vh-250px)]">
        <div class="w-1/3 bg-gray-200 rounded p-4 flex flex-col gap-2 ">
            <div class="flex justify-between">
                <h1 class="uppercase font-bold text-lg">{{ $doc->titulo }}</h1>
                <p class="text-blue-500 text-lg">{{ $doc->codigo }}</p>
            </div>

            <div>
                <h2 class="font-bold uppercase text-md">Informacion</h2>
                <div>
                    <p class="text-sm mb-2">{{ $doc->descripcion }}</p>
                    <p><span class="uppercase font-bold"> Tipo de Documento:</span> {{ $doc->tipo }}</p>
                    <p><span class="uppercase font-bold"> Area correspondiente: </span> {{ $doc->area }}</p>
                    <p><span class="uppercase font-bold"> Version: </span> {{ $doc->version }}</p>
                    <p><span class="uppercase font-bold"> Estado: </span> {{ $doc->estado }}</p>
                </div>
                <h2 class="font-bold uppercase text-md">Descargables</h2>
                <div class="flex justify-center gap-2">
                    @if ($doc->pdf_path)
                        <a href="{{ asset('storage/' . $doc->pdf_path) }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-8 w-8 fill-red-500">
                                <path
                    ...
                    @if ($doc->word_path)
                        <a href="{{ asset('storage/' . $doc->word_path) }}"
                            ...
                            class="text-green-500 hover:text-green-700 ml-2">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="h-8 w-8 fill-blue-500">
                                <path
        ...
        <div class="w-2/3 h-full flex flex-col gap-2">
            <div class="h-1/2 bg-gray-200 rounded p-4">
                <h1 class="uppercase font-bold text-lg">Procedimientos de la misma area</h1>
            ...
            <div class="h-1/2 bg-gray-200 rounded p-4">
                <h1 class="uppercase font-bold text-lg">Documentos del mismo procedimiento</h1>
                <table class="w-full text-xs text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <thead
                        class="sticky top-0 z-10 text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
