    ...
    <div class="relative w-full  max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form class="p-4 md:p-5 text-left" wire:submit="submit" novalidate>
                ...
                <div class="form-group">
                    <label for="maquina_equipo_id"
                        class="block mb-1 text-sm font-medium text-gray-900 dark:text-white capitalize">Máquina
                        (opcional)</label>
                    ...
                    <select wire:model="maquina_equipo_id"
                        ...
                        @endforeach
                        @if($maquinas->isEmpty())
                            <option disabled>No se encontraron máquinas</option>
                        @endif
                    </select>
