        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form class="p-4 md:p-5 text-left" wire:submit="submit" novalidate>
                ...
                <div class="form-group">
                    <label for="tiempo_respuesta"
                        class="block mb-1 text-sm font-medium text-gray-900 dark:text-white capitalize">Tiempo de respuesta</label>
                    <input type="datetime-local" id="tiempo_respuesta" wire:model="tiempo_respuesta"
                        class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ old('tiempo_respuesta') }}">
                    @error('tiempo_respuesta')
                ...
                <div class="form-group">
                    <label for="accion"
                        class="block mb-1 text-sm font-medium text-gray-900 dark:text-white capitalize">Accion realizada</label>
                    <input type="text" id="tiempo_respuesta" wire:model="accion"
                        class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ old('accion') }}">
                    @error('accion')
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"> {{ $message }}</p>
