<div>
    <form class="space-y-2" wire:submit.prevent="submit">
        ...
        <div>
            <label for="codigo"
                class="block mb-1 text-sm md:text-md font-medium text-gray-900 dark:text-white">Código</label>
        ...
        <div>
            <label for="nombre"
                class="block mb-1 text-sm md:text-md font-medium text-gray-900 dark:text-white">Trabajador</label>
        ...
        <div>
            <label for="detalle"
                class="block mb-2 text-sm md:text-md font-medium text-gray-900 dark:text-white">Detalle </label>
        ...
        <div class="flex gap-4">
            <div class="flex items-center p-2">
                <div class="flex items-center">
                    ...
                    <label for="esparatrapo"
                        class="text-sm font-medium text-gray-900 dark:text-white">Esparadrapo</label>
                </div>
            </div>
