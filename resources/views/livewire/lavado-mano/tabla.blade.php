<div>
    ...
    <div class="flex flex-wrap gap-4 mb-4 items-end p-2 bg-gray-50 rounded-lg">
        ...
        <div class="flex-1">
            ...
            <select  wire:model.live.debounce.300ms="sector" class="mt-1 block  rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm w-full">
                    ...
                    <tr
                        ...
                        <td class="px-2 py-1.5">
                            @if (auth()->user()->rol === 'Admi' ||
                                    (auth()->user()->rol === 'Supervisor' && now()->diffInMinutes($lavado->created_at) <= 60))
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                                    class="w-4 h-4 fill-red-600" wire:click="delete({{ $lavado->id }})"
                                    wire:confirm="Esta seguro que desea borrar el registro?">
                                    <path
