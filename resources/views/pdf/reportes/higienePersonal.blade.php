...
<head>
    ...
    <title> PLP - PRO - 601 - REG - 01 Registro Control Higiene del  personal</title>
    <style>
        @page {
            margin-top: 1cm;
            margin-bottom: 0cm;
...
<header>
    <table class="head" style="border: 1px solid black;font-size: 0.8rem; margin-bottom: 0.6rem">
        <tr>
            ...
            <th style="width: 25%; font-size: 0.8rem">PLP - PRO - 601 - REG - 01 <br> Versión 003 <br>
                <div class="page-number"></div>
            </th>
        </tr>
        <tr>
            <td colspan="3" style="text-align: center; padding: 0.6rem;  font-weight:bold;">Registro Control Higiene del  personal</td>
        </tr>
    </table>
</header>
            ...
            <table class="table-pdf">
                ...
                <tbody>
                    @foreach ($users as $userData)
                        <tr>
                            <td>{{ $userData['user']->codigo }}</td>
                            <td>{{ $userData['user']->lastname }} {{ $userData['user']->name }}</td>
                            @foreach ($dates as $date)
                                @php
                                ...
                                <td class="text-center">
                                    ...
                                    @elseif ($status === 'warning')
                                        Obs: {{ $details['observaciones'] ?? 'N/A' }}<br>
                                        Corr: {{ $details['correccion'] ?? 'N/A' }}
                                    @else
                                        -
                                    @endif
                                </td>
