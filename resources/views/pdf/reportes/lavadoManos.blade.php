...
<header>
    <table class="head" style="border: 1px solid black;font-size: 0.8rem; margin-bottom: 0.6rem">
        <tr>
            ...
            <th style="width: 25%; font-size: 0.8rem">PLP - PRO - 601 - REG - 02 <br> Versión 003 <br>
                <div class="page-number"></div>
            </th>
        </tr>
        <tr>
            <td colspan="3" style="text-align: center; padding: 0.6rem;  font-weight:bold;">Registro Control Lavado
                de Manos</td>
        </tr>
    </table>
</header>
                ...
                <tbody>
                    @foreach ($users as $userData)
                        <tr>
                            ...
                            @foreach ($dates as $date)
                                <td class="{{ $userData['data'][$date] >= 1 ? 'green' : 'red' }}">
