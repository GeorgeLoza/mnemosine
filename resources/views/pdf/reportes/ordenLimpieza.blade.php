...
<head>
    ...
    <title>PLP - PRO - 601 - REG - 02 Registro Control Lavado de Manos</title>
    <style>
        @page {
            margin-top: 1cm;
            margin-bottom: 0cm;
...
<header>
    <table class="head" style="border: 1px solid black;font-size: 0.8rem; margin-bottom: 0.6rem">
        <tr>
            ...
            <th style="width: 25%; font-size: 0.8rem">PLP - PRO - 602 - REG - 01 <br> Versión 003 <br>
                <div class="page-number"></div>
            </th>
        </tr>
        <tr>
            <td colspan="3" style="text-align: center; padding: 0.6rem;  font-weight:bold;">Registro Orden Limpieza y
                Desinfeccion</td>
        </tr>
    </table>
</header>
        ...
        <main>
            ...
            <table class="table-pdf">
                ...
                <tbody>
                    @forelse ($reportes['diario'] as $item)
                        <tr>
                            <td>{{ $item['orden']->responsable }}</td>
                            <td>{{ $item['orden']->area }}</td>
                            <td>{{ $item['orden']->detalle ?? '-' }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ 3 + count($diarioRange) }}">No hay registros diarios</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <table class="table-pdf">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ 3 + count($semanalRange) }}">No hay registros semanales</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <table class="table-pdf">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ 3 + count($mensualRange) }}">No hay registros mensuales</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
