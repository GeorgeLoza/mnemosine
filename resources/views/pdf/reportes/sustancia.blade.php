...
<header>
    <table class="head" style="border: 1px solid black;font-size: 0.8rem; margin-bottom: 0.6rem">
        <tr>
            ...
            <th style="width: 25%; font-size: 0.8rem">PLP - PRO - 602 - REG - 02 <br> Versión 003 <br>
                <div class="page-number"></div>
            </th>
        </tr>
        <tr>
            <td colspan="3" style="text-align: center; padding: 0.6rem;  font-weight:bold;">Entrega de insumos</td>
        </tr>
    </table>
</header>
                            ...
                            <td>
                                @if ($movimiento->tipo == 'Ingreso')
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"
                                        class="width: 0.75rem; fill-green-500">
                                        <path
