...
@section('titulo')
    ...
    <h1>Reporte - Orden Limpieza y Desinfeccion</h1>
    <div class="flex gap-2">
        <div><a href="{{ route('verOrdLimDes.index') }}">
            <button class="px-2 py-1 bg-blue-500 rounded-lg text-xs text-white uppercase">
                tabla</button>
        </a> </div>

        <div><a href="{{ route('mobile.verOLD') }}">
...
@section('contenido')
    @livewire('VerificacionOrdenLimpieza.reporte')
@endsection
