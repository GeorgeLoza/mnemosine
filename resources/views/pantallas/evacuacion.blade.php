...
@section('titulo')
    <div class="text-blue-500 font-light text-sm">PLP-PRO-604-REG-01</div>
    <h1>EVACUACIÓN DE RESIDUOS SÓLIDOS</h1>
    <div class="flex gap-2">
        <a href="{{ route('evacuacionReporte.index') }}">
    ...
    <div>
        <div class="hidden md:flex gap-1">
            <div><button class="px-2 py-1 bg-green-500 rounded-lg text-xs text-white uppercase"
                onclick="Livewire.dispatch('openModal', { component: 'evacuacion.crear' })">
                nuevo</button></div>
        </div>
    </div>
    </div>
