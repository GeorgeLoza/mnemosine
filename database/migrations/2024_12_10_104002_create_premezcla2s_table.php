...
return new class extends Migration
{
    ...
    {
        Schema::create('premezcla2s', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('lecitina_soya', 8, 4)->nullable();
            $table->decimal('extracto_malta', 8, 4)->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('premezcla2s');
    }
};
