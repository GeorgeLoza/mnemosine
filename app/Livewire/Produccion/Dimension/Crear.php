...
namespace App\Livewire\Produccion\Dimension;
...
class Crear extends ModalComponent
{
    ...
    private function generarOpciones($lote)
    {
        ...
        $preparacionesUsadas = Dimension::where('orp_id', $this->orp)
    ...
    {
        return view('livewire.produccion.dimension.crear');
    }
    ...
    public function submit()
    {
        ...
        try {
            Dimension::create([
                ...
                'orp_id' => $this->orp,
                'altura_total' => $this->altura_total,
                'diametro' => $this->diametro,
                'altura_base' => $this->altura_base,
                'altura_feta_centro' => $this->altura_feta_centro,
                'altura_split' => $this->altura_split,
                'ancho_split' => $this->ancho_split,
                'peso' => $this->peso,
