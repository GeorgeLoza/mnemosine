...
namespace App\Livewire\Produccion\Corte;
...
class Crear extends ModalComponent
{
    ...
    private function generarOpciones($lote)
    {
        ...
        $preparacionesUsadas = Corte::where('orp_id', $this->orp)
    ...
    {
        return view('livewire.produccion.corte.crear');
    }
    ...
    public function submit()
    {
        ...
        try {
            Corte::create([
                ...
                'orp_id' => $this->orp,
                'temperatura_corte' => $this->temperatura_corte,
